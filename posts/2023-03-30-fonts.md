...
- [Martian Mono](https://github.com/evilmartians/mono): wide font with bold,
  strong look.
- [0xProto](https://github.com/0xType/0xProto): found it on Instagram, wish it
  has dotted zero.
...
- [Routed Gothic Font](https://webonastick.com/fonts/routed-gothic/): aircraft
  font vibe.
- [Martian Grotesk](https://github.com/evilmartians/grotesk): same as Martian
  Mono but for display.
