...
I recommend to use [HD textures](https://gbatemp.net/threads/resident-evil-4-hd-textures-update-2-3.615869/), it's
...
Take a look at [NoPayStation](https://nopaystation.com/) to download games.

Use [rusty-psn](https://github.com/RainbowCookie32/rusty-psn) to download updates.
